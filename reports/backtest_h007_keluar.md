# Backtest H-007 — h007_keluar

> Dengan sinyal Donchian yang tidak diubah sama sekali, memperlakukan rasio imbalan sebagai parameter yang dipilih walk-forward menghasilkan ekspektasi bersih di luar sampel minimal 0,05R. Yang diuji adalah titik impas, bukan sinyal: titik impas kotor adalah 1/(1+imbalan), sehingga imbalan 3R menurunkannya dari 0,333 ke 0,250.

Sidik `7f5e7aeeaa29284b` · 12 kombinasi · 40 simbol · 51.5s
...
- Perdagangan: **14,962**
- Total R: **605.10**
- Ekspektasi: **0.04044263223774163**
- Jendela positif: 199/356
...
| invarian_risiko | GAGAL | -1.9769 | -1.5 | kerugian terburuk -1.977R dari 14962 perdagangan |
| funding | lulus | 10190.1550 | 0.0 | total funding mutlak 10190.154984 atas 14962 trade |
...
- Rerata jarak stop terhadap harga: **3.607%**
...
|---|---|
| `{"imbalan_R": 4.0, "lookback": 100}` | 83 |
| `{"imbalan_R": 4.0, "lookback": 20}` | 66 |
| `{"imbalan_R": 4.0, "lookback": 55}` | 45 |
| `{"imbalan_R": 3.0, "lookback": 20}` | 40 |
| `{"imbalan_R": 3.0, "lookback": 100}` | 32 |
| `{"imbalan_R": 3.0, "lookback": 55}` | 29 |
| `{"imbalan_R": 2.0, "lookback": 20}` | 15 |
| `{"imbalan_R": 2.0, "lookback": 55}` | 12 |
| `{"imbalan_R": 2.0, "lookback": 100}` | 11 |
